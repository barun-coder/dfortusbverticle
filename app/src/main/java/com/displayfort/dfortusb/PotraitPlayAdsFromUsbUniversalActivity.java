 ...
 * MyApplication
 */
public class PotraitPlayAdsFromUsbUniversalActivity extends BaseSupportActivity implements SurfaceHolder.Callback {
    ...
    private void check() {
        try {
            ...
            for (File inFile : files) {
                Toast.makeText(PotraitPlayAdsFromUsbUniversalActivity.this, "" + inFile.getAbsolutePath(), Toast.LENGTH_SHORT).show();
