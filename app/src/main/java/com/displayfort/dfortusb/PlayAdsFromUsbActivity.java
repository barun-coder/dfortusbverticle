 ...
 * MyApplication
 */
public class PlayAdsFromUsbActivity extends BaseSupportActivity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener {
    ...
    private void showCurrentAd() {
        ...
        try {
                            ...
                            if (interval != 0) {
                                ...
                                try {
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                        mMediaPlayer.setDataSource(photoPath);
                                    } else {
                                    }
            ...
            Log.e("Handeledexception", e.getMessage());
            mSurfaceView.setVisibility(View.INVISIBLE);
            displayImageView.setVisibility(View.VISIBLE);
            Handler handler = new Handler();
            if (currentAdvertisementNo < (completFileList.length - 1)) {
